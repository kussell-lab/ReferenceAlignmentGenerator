...
JOBDIR=${PROJDIR}/APS173map2ref
WRKDIR=${PROJDIR}/APS173_senterica
REF=${PROJDIR}/APS173_SE_Archive/reference/GCF_000006945.2_ASM694v2_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS173map2ref_${line}.sh
...
#SBATCH --mem=2GB
#SBATCH --job-name=APS173map2ref_${line}
