...
#SBATCH --time=1:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=SAgalsplitgenome
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS185splitgenome_slurm%j.out


##INPUTS
ARCHIVE=/scratch/aps376/recombo/APS185_SAgal_Archive
MSA=${ARCHIVE}/MSA_SAgal_MASTER_GAPFILTERED
