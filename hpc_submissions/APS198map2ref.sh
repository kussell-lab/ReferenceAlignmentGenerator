...
JOBDIR=${PROJDIR}/APS198map2ref
WRKDIR=${PROJDIR}/APS198_sflexneri
REF=${PROJDIR}/APS198_SF_Archive/reference/GCF_000006925.2_ASM692v2_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS198map2ref_${line}.sh
