...
#SBATCH --time=4:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=PA_clustersplit
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=PA_clustersplit_slurm%j.out


##INPUTS
cluster_dict=/scratch/aps376/recombo/APS189_PA_Archive/cluster_list
msa_dir=/scratch/aps376/recombo/APS202_PA_Archive
out=${msa_dir}
