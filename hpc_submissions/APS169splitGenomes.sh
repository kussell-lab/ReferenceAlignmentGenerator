...
echo "let's rock"
mkdir -p ${ARCHIVE}/corethreshold90
splitGenome ${MSA} ${list} 90 ${ARCHIVE}/corethreshold90 --threads=16 --num-cpu=16
mkdir -p ${ARCHIVE}/corethreshold95
splitGenome ${MSA} ${list} 95 ${ARCHIVE}/corethreshold95 --threads=16 --num-cpu=16
mkdir -p ${ARCHIVE}/corethreshold99
splitGenome ${MSA} ${list} 99 ${ARCHIVE}/corethreshold99 --threads=16 --num-cpu=16
