...
#SBATCH --output=APS169filter_slurm%j.out


##INPUTS
projdir=/scratch/aps376/recombo
jobdir=${projdir}/APS169filtergaps
archive=${projdir}/APS169_SP_Archive
msa=${projdir}/APS156_SP_Archive/SP_MASTER_OUT/MSA_SP_MASTER
