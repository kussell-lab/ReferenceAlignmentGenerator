...
JOBDIR=${PROJDIR}/APS199map2ref
WRKDIR=${PROJDIR}/APS199_hinfluenzae
REF=${PROJDIR}/APS199_HI_Archive/reference/GCF_000767075.1_ASM76707v1_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS199map2ref_${line}.sh
