...
JOBDIR=${PROJDIR}/APS191map2ref
WRKDIR=${PROJDIR}/APS191_vcholerae
REF=${PROJDIR}/APS191_VC_Archive/reference/GCF_000829215.1_ASM82921v1_genomic.fna
...
for line in 0; do
#for line in {1..99}; do #for line in 0
  echo "submitting list ${line}"
  jobfile=$SUBMITDIR/APS190map2ref_${line}.sh
