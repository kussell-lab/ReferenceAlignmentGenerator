...
JOBDIR=${PROJDIR}/APS189map2ref
WRKDIR=${PROJDIR}/APS189_paeruginosa
REF=${PROJDIR}/APS189_PA_Archive/reference/GCF_000006765.1_ASM676v1_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS189map2ref_${line}.sh
