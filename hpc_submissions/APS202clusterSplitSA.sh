...
#SBATCH --time=4:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=SA_clustersplit
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=SA_clustersplit_slurm%j.out


##INPUTS
cluster_dict=/scratch/aps376/recombo/APS170_SA_Archive/cluster_list
msa_dir=/scratch/aps376/recombo/APS202_SA_Archive
out=${msa_dir}
