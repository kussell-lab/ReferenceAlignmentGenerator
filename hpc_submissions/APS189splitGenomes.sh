...
#SBATCH --time=1:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=PAsplitgenome
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS189splitgenome_slurm%j.out


##INPUTS
ARCHIVE=/scratch/aps376/recombo/APS189_PA_Archive
MSA=${ARCHIVE}/MSA_PA_MASTER_GAPFILTERED
