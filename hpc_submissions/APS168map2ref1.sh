...
JOBDIR=${PROJDIR}/APS168map2ref
WRKDIR=${PROJDIR}/APS168_SARS-CoV-2
REF=${PROJDIR}/APS168_SC2_Archive/reference/GCF_009858895.2_ASM985889v3_genomic.fasta
LISTS=$JOBDIR/piles_tbc1
...
for line in {0..199}; do #for line in 0
  echo "submitting list ${line}"
  jobfile=$SUBMITDIR/APS168map2ref_${line}.sh
