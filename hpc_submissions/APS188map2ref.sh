...
JOBDIR=${PROJDIR}/APS188map2ref
WRKDIR=${PROJDIR}/APS188_kpneumoniae
REF=${PROJDIR}/APS188_KP_Archive/reference/GCF_000240185.1_ASM24018v2_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS188map2ref_${line}.sh
