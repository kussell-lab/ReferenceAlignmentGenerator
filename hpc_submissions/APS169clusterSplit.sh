...
#SBATCH --output=APS169clustersplit_slurm%j.out
...
echo "let's rock"
cd ${ARCHIVE}/corethreshold90
clusterSplit MSA_CORE ${ARCHIVE}/corethreshold90 ${cluster_dict} --FLEX_MSA=MSA_FLEX --num-cpu=4
cd ${ARCHIVE}/corethreshold95
clusterSplit MSA_CORE ${ARCHIVE}/corethreshold95 ${cluster_dict} --FLEX_MSA=MSA_FLEX --num-cpu=4
cd ${ARCHIVE}/corethreshold99
clusterSplit MSA_CORE ${ARCHIVE}/corethreshold99 ${cluster_dict} --FLEX_MSA=MSA_FLEX --num-cpu=4
