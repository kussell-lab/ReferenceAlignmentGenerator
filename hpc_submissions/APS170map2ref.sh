...
JOBDIR=${PROJDIR}/APS170map2ref
WRKDIR=${PROJDIR}/APS170_saureus
REF=${PROJDIR}/APS170_SA_Archive/reference/GCF_000013425.1_ASM1342v1_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS170map2ref_${line}.sh
