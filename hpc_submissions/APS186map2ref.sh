...
JOBDIR=${PROJDIR}/APS186map2ref
WRKDIR=${PROJDIR}/APS186_paeruginosa
REF=${PROJDIR}/APS186_PA_Archive/reference/GCF_000006765.1_ASM676v1_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS186map2ref_${line}.sh
