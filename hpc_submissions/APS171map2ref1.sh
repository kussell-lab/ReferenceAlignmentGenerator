...
JOBDIR=${PROJDIR}/APS171map2ref
WRKDIR=${PROJDIR}/APS171_ngonorrhoeae
REF=${PROJDIR}/APS171_NG_Archive/reference/GCF_001047275.1_ASM104727v1_genomic.fna
...
for line in {0..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS171map2ref_${line}.sh
