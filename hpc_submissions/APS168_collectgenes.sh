...
#SBATCH --mem=16GB
#SBATCH --job-name=APS168genes
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS168genes_slurm%j.out


##INPUTS
projdir=/scratch/aps376/recombo
jobdir=${projdir}/APS168_collectgenes
archive=${projdir}/APS168_SC2_Archive
list=${archive}/APS168_completepiles
ref=${archive}/reference/GCF_009858895.2_ASM985889v3_genomic.fasta
gff=${archive}/reference/GCF_009858895.2_ASM985889v3_genomic.gff
...
CollectGeneAlignments ${list} ${gff} ${workdir} ${archive}/MSA_SC2_MASTER --appendix ".pileup.fasta" --progress