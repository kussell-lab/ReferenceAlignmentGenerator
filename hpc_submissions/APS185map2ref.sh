...
JOBDIR=${PROJDIR}/APS185map2ref
WRKDIR=${PROJDIR}/APS185_sagalactiae
REF=${PROJDIR}/APS185_SAgal_Archive/reference/GCF_900638415.1_57635_F01_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS185map2ref_${line}.sh
