...
#SBATCH --time=1:00:00
#SBATCH --mem=4GB
#SBATCH --job-name=VCsplitgenome
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS191splitgenome_slurm%j.out


##INPUTS
ARCHIVE=/scratch/aps376/recombo/APS191_VC_Archive
MSA=${ARCHIVE}/MSA_VC_MASTER_GAPFILTERED
