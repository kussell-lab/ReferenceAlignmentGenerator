...
JOBDIR=${PROJDIR}/APS187map2ref
WRKDIR=${PROJDIR}/APS187_ecoli
REF=${PROJDIR}/APS187_EC_Archive/reference/GCF_000005845.2_ASM584v2_genomic.fna
...
#for line in {1..199}; do #for line in 0
  ...
  jobfile=$SUBMITDIR/APS187map2ref_${line}.sh
