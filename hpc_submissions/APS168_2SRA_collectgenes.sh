...
#SBATCH --time=0:30:00
#SBATCH --mem=2GB
#SBATCH --job-name=APS168collect
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=aps376@nyu.edu
#SBATCH --output=APS168collect_slurm%j.out
...
CollectGeneAlignments ${list} ${gff} ${workdir} ${archive}/MSA_SC2_2strains --appendix ".pileup.fasta" --progress